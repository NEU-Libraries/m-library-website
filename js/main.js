...
+function(a) {
    ...
    a.fn.carousel = function(c) {
        ...
        f.carousel(g), (d = e.attr("data-slide-to")) && f.data("bs.carousel").pause().to(d).cycle(), 
        b.preventDefault();
    }), a(window).on("load", function() {
    ...
    b.DEFAULTS = {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            var b = this.dimension(), c = a.camelCase([ "scroll", b ].join("-")), d = this.$parent && this.$parent.find("> .accordion-group > .in");
            if (d && d.length) {
                var e = d.data("collapse");
                if (e && e.transitioning) return;
                d.collapse("hide"), e || d.data("collapse", null);
            }
            this.$element[b](0), this.transition("addClass", a.Event("show.bs.collapse"), "shown.bs.collapse"), 
            a.support.transition && this.$element[b](this.$element[0][c]);
        }
    }, b.prototype.hide = function() {
        if (!this.transitioning && this.$element.hasClass("in")) {
            var b = this.dimension();
            this.reset(this.$element[b]()), this.transition("removeClass", a.Event("hide.bs.collapse"), "hidden"), 
            this.$element[b](0);
        }
        ...
        this;
    }, b.prototype.transition = function(b, c, d) {
    ...
    a.fn.collapse = function(c) {
        return this.each(function() {
            var d = a(this), e = d.data("collapse"), f = a.extend({}, b.DEFAULTS, d.data(), "object" == typeof c && c);
            e || d.data("collapse", e = new b(this, f)), "string" == typeof c && e[c]();
        });
    }, a.fn.collapse.Constructor = b, a.fn.collapse.noConflict = function() {
        return a.fn.collapse = c, this;
    }, a(document).on("click.bs.collapse.data-api", "[data-toggle=collapse]", function(b) {
        var c, d = a(this), e = d.attr("data-target") || b.preventDefault() || (c = d.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, ""), f = a(e).data("collapse") ? "toggle" : d.data(), g = d.attr("data-parent"), h = g && a(g);
        h && h.find("[data-toggle=collapse][data-parent=" + g + "]").not(d).addClass("collapsed"), 
    ...
    b.prototype.getDefaults = function() {
        ...
        var a = "function" == typeof this.options.content ? this.options.content.call(this.$element[0]) : this.options.content;
        return a || this.$element.attr("data-content");
